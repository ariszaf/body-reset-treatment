...
export const faq: FaqItem[] = [
  {
    ...
    answer:
      'Ναι. Το Body Reset Treatment αποτελεί αποκλειστικά υπηρεσία κατ’ οίκον. Η συνεδρία πραγματοποιείται στον δικό σας χώρο, σε όλη την Αθήνα και τα περίχωρα. Δεν διατηρούμε φυσικό κατάστημα ή studio.',
  },
  {
